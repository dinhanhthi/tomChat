...
export default function Messages(props: { className?: string }) {
...
const exMsgs: Message[] = [
  ...
  {
    id: '8',
    content: "Certainly! When you want to display a math equation in block format using LaTeX, you can enclose it with `\\[ ... \\]`. Here's an example of a block display math equation using this notation:\n\n\\[\nE = mc^2\n\\]\n\nThis equation represents Einstein's famous mass-energy equivalence formula, where \\( E \\) is energy, \\( m \\) is mass, and \\( c \\) is the speed of light in a vacuum.",
    role: 'assistant'
  }
]